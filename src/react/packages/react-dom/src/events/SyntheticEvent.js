...
function createSyntheticEvent(Interface: EventInterfaceType) { //定义合成事件构造函数过程
  /**
  ...
  Object.assign(SyntheticBaseEvent.prototype, {
    ...
    stopPropagation: function() {
      ...
      this.isPropagationStopped = functionThatReturnsTrue;  //标识是否有调用isPropagationStopped
    },
     ...
     */
    persist: function() {
      // Modern event system doesn't use pooling. //为了保证代码不报错，API接口保留，但无任何功能
    },
